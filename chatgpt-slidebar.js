...
(function () {
  ...
  function rd(a) {
    function b(b2, d, e, f2, g) {
      ...
      this.isDefaultPrevented = (
        null != f2.defaultPrevented ? f2.defaultPrevented : false === f2.returnValue
      )
        ? pd
        : qd;
        ...
        if (void 0 !== h2) {
          ...
          for (var w2 = d2, u2; null !== w2; ) {
            ...
            5 === u2.tag &&
              null !== F2 &&
              ((u2 = F2),
              null !== x2 && ((F2 = Kb(w2, x2)), null != F2 && t2.push(tf(w2, F2, u2))));
            if (J2) break;
            w2 = w2.return;
          }
          0 < t2.length &&
  ...
  function queryChatContainer() {
    ...
    return (_a = document.querySelector('main')) == null
      ? void 0
      : _a.querySelector(className2Selector(CHAT_LIST_EL_CLASS));
  }
  function queryQuestionEls() {
    var _a;
    return Array.from(((_a = queryChatContainer()) == null ? void 0 : _a.children) ?? [])
    ...
    const questions = reactExports.useMemo(
      () =>
        questionEls
          .map((q2) => {
            var _a;
            return (_a = q2.querySelector('[data-message-author-role]')) == null
              ? void 0
              : _a.innerText;
          })
          .filter((s) => !!s),
  ...
  function App() {
    ...
    const handleClickList = (event) => {
      ...
      if (event.target instanceof HTMLLIElement) {
        ...
        (_a = questionEls == null ? void 0 : questionEls[targetIndex]) == null
          ? void 0
    ...
    const filtered = reactExports.useMemo(() => {
      ...
      if (!q2) return questions.map((text, index) => ({ text, index }));
      return questions
        .map((text, index) => ({ text, index }))
        .filter(({ text }) => text.toLowerCase().includes(q2));
    }, [questions, query]);
    const scrollToIndex = (index) => {
      ...
      (_a = questionEls == null ? void 0 : questionEls[index]) == null
        ? void 0
        : _a.scrollIntoView({ behavior: 'smooth' });
    };
    const handleKeyDown = (e) => {
      ...
      if (e.key === 'ArrowDown') {
        ...
        if (target) scrollToIndex(target.index);
  ...
  *,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}
  ...
  [scrollbar~="w-4px"]{--scrollbar-width:4px;}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          className: `transition-width ${show ? 'w-[var(--app-width)]' : 'w-22px'} `,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
              className: 'flex items-center select-none justify-between pb-2',
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                  ...
                  children: [
                    ...
                    show &&
                      /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                        className:
                          'ml-1 rounded-full bg-gray-100 px-1.5 py-0.5 text-10px text-gray-600',
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx('input', {
                    ...
                    placeholder: 'Search...',
                    className:
                      'w-full rounded border border-gray-200 px-2 py-1 text-12px outline-none focus:ring-2 focus:ring-brand-primary',
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              className:
                "relative after:content-[''] after:absolute after:bottom-0 after:right-4px after:w-full after:h-.7em after:bg-gradient-to-t after:from-white after:from-opacity-90 after:to-white after:to-opacity-20",
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs('ul', {
                ref: elRef,
                className:
                  'max-h-[var(--app-max-list-height)] list-inside list-disc overflow-y-auto ',
                ...
                children: [
                  ...
                  !filtered.length &&
                    /* @__PURE__ */ jsxRuntimeExports.jsx('li', {
                      className: 'text-12px text-gray-400 py-1 px-1',
                      children: 'No results',
                    }),
                ],
              }),
